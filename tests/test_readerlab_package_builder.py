...
class ReaderLabPackageBuilderTests(unittest.TestCase):
    def test_builds_shareable_package_with_audit(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertTrue((package_root / "tests/engineering_route_smoke_test.py").is_file())
            ...
            self.assertTrue((package_root / "fixtures/engineering-route-smoke-v0/audit/source-excerpts/skill-body.md").is_file())
