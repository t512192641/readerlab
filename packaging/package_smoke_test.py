...
REQUIRED_FILES = (
    ...
    "tests/book_route_smoke_test.py",
    "tests/longform_route_smoke_test.py",
    "tests/engineering_route_smoke_test.py",
    ...
    "docs/readerlab-v2-book-route-smoke.md",
    ...
    "fixtures/longform-route-smoke-v0/audit/source-excerpts/report-argument.md",
    "fixtures/engineering-route-smoke-v0/audit/source-excerpts/skill-body.md",
    "PACKAGE_BOUNDARY.md",
    "PACKAGE_AUDIT.json",
