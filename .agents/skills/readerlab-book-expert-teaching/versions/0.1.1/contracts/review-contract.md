...
Review output URLs are checked mechanically: a new URL or a `blocked` URL fails sealing; an existing `reference_only` URL is permitted only as a citation, never as an opening permission.
